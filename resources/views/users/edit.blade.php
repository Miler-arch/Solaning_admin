    ...
    <div class="card bg-light mt-2 shadow">
        ...
        <form action="{{route('users.update', $user->id )}}" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <x-adminlte-input name="name" label="Nombre Completo :" value="{{$user->name}}" label-class="text-light-emphasis">
                    ...
                    <div class="col-6">
                        <x-adminlte-input name="lastname" label="Apellidos :" value="{{$user->lastname}}"  label-class="text-light-emphasis">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                                    <i class="fas fa-user text-light-emphasis"></i>
                                </div>
                    ...
                    <div class="col-6">
                        <x-adminlte-input name="email" label="Correo Electrónico :" value="{{$user->email}}"  type="email" label-class="text-light-emphasis">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-6">
                        <x-adminlte-input name="phone" label="Teléfono :" value="{{$user->phone}}"  label-class="text-light-emphasis" min="0">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
                    ...
                    <div class="col-lg-6 col-12">
                        <x-adminlte-input name="ci" label="Cédula de Identidad :" type="number" value="{{$user->ci}}" label-class="text-secondary">
                            <x-slot name="prependSlot">
                                <div class="input-group-text">
            ...
            <div class="text-center py-2 pb-4">
                <div>
                    <a class="btn btn-primary mx-3" href="{{route('users.index')}}">Cancelar</a>
