        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/css/buttons.bootstrap5.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/js/dataTables.buttons.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/js/buttons.bootstrap5.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/js/buttons.html5.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/js/buttons.print.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.datatables.net/buttons/2.0.1/js/buttons.colVis.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
